...
@EnableJpaRepositories(
						basePackages="kw.kng.repo.mysql.ds1",
						entityManagerFactoryRef="mysqlEMF1",
						transactionManagerRef="mysqlTxMgmr1"
					   )
public class MySqlDb1Config 
{
	...
	@Primary
	public DataSource createMySqlDS1() {
...
//makes EntityManagerFactory as Spring bean
		return builder.dataSource(createMySqlDS1()) // datasource
				.packages("kw.kng.entities.mysql.ds1") // model class pacakage
...
// Configure Transaction Manager
	...
	@Bean(name = "mysqlTxMgmr1")
	@Primary
	public PlatformTransactionManager createMysqlTxMgmr(@Qualifier("mysqlEMF1") EntityManagerFactory factory) {
