...
import kw.kng.entities.mysql.ds1.Offers;
import kw.kng.entities.mysql.ds2.Product;
import kw.kng.repo.mysql.ds1.OffersRepo;
import kw.kng.repo.mysql.ds2.ProductRepo;

@Component
public class MySql2DsRunner implements CommandLineRunner
{
	@Autowired
