...
import kw.kng.entities.oracle.ds1.Offers;
import kw.kng.entities.oracle.ds2.Product;
import kw.kng.repo.oracle.ds1.OffersRepo;
import kw.kng.repo.oracle.ds2.ProductRepo;

@Component
public class OracleDsRunner implements CommandLineRunner
{
	@Autowired
