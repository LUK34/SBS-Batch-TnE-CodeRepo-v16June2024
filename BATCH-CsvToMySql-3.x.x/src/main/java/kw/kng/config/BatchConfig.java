...
import org.springframework.batch.core.step.builder.StepBuilder; //for 3.x.x
...
public class BatchConfig	//SpringBoot version: 3.3.1
{
	/*
...
/*
	...
	*/
	...
	{
		//The parameteres of this method, We are able to acces the resources through auto-configuration.
		
		return /*stepBuilder.get("step1")*/	new StepBuilder("step1", jobRepository)
	...
	public Job createJob(JobRepository jobRepository, Step step1)
	{
		...
		return  /* jobBuilder.get("job1") */ new JobBuilder("job",jobRepository)
						 .listener(listener)
